  ...
  return (
    <div className="absolute top-0 z-[-1] left-0 w-full h-full overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div
          className="absolute inset-0 bg-gradient-to-r z-[1] from-transparent to-white mix-blend-overlay"
          //   style={{
          //     backgroundImage:
          ...
          style={{
            backgroundImage:
              "radial-gradient(40% 50% at 50% 50%, rgba(255, 255, 255, 0) 80%, #FFF 100%)",
            maskImage:
              "radial-gradient(40% 50% at 50% 50%, rgba(255, 255, 255, 0) 80%, #FFF 100%)",
          }}
        ></div>
